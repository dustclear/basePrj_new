 ...
 * 2014-11-28T16:09:25.988+08:00
 * Generated source version: 2.7.13
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", 
                  wsdlLocation = "http://localhost:8080/cxf_spring_mybatis/webservice/HelloWorld?wsdl",
...
public class HelloWorldImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/cxf_spring_mybatis/webservice/HelloWorld?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/cxf_spring_mybatis/webservice/HelloWorld?wsdl");
        }
        WSDL_LOCATION = url;
    }
